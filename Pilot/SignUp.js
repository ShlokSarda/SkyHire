...
function authenticate(){
    ...
    if(isValidPhoneNumber("+91"+number)){
        const xhr = new XMLHttpRequest();
            xhr.open("GET", "../assets/database/Pilot/check_number.php?number=" + number, true);
...
function doPost(){
    ...
    const rpc_number = document.getElementById("rpc_number").value;
    ...
    fetch("../assets/database/Pilot/Pilot_Signup.php", {
        method: "POST",
        headers: {
    ...
    .then(data => {
        ...
        window.location.href="Pilot Dashboard/Pilot_Dashboard.php";
