...
$statement = $pdo->prepare("SELECT * FROM host_bookings where Host_Id is NULL");
$statement->execute();
...
$statement1 = $pdo->prepare("SELECT * FROM host_bookings WHERE Host_Id= :host AND Date = :date");
$statement1->bindParam(':host', $host_id);
...
<head>
    ...
    <link rel="stylesheet" href="./Host_Dashboard.css">
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <title>SkyHire-Host Dashboard</title>
</head>
<body>
    <header class="header" data-header>
        ...
        <div class="container">
            <div class="button-container">
                <a href="./add_drone.html" class="add-drone"><i class="fa-solid fa-plus"></i> Add Drone</a>
            </div>
            <div class="button-container">
        ...
        <div class="container1-1">
          <div class="pending-req">
            ...
            <?php foreach ($bookings as $booking): ?>
              <div class="booking">Booking Id: <?php echo $booking['Booking_Id']?><br>
              Customer Name: <?php echo $booking['Customer_Name']?><br>
              Hours: <?php echo $booking['Hours']?><br>
              Date: <?php echo $booking['Date']?><br>
              Time: <?php echo $booking['Time']?><br>
              ...
              <button class="decline-button" onclick="declineBooking(<?php echo $booking['Booking_Id']?>,'booking_<?php echo $booking['Booking_Id'];?>')">Decline</button>
              <br><br>
              <?php endforeach; ?>
            </div>
            <?php else: ?>
    ...
    <div class="wrapper" id="wrapper">
      ...
      <script src="./Host_Dashboard.js" defer></script>
</body>
</html>